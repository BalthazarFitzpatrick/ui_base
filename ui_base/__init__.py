...
WHAT THIS IS. A handful of plain files - one stylesheet and three scripts - that a local tool can
serve to get menus, dropdowns, tab shells, sliders, pan/zoom and crop alignment that all look and
